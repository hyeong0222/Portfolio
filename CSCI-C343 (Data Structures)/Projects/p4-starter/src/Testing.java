...
public class Testing {
   ...
   */
	 ...
	 */
	@Test
	public void huffTest() {
		FrequencyTable ft = new FrequencyTable("aabbbcddddeeeee");
		assertTrue(2 == ft.get('a'));
		assertTrue(3 == ft.get('b'));
		assertTrue(1 == ft.get('c'));
		assertTrue(4 == ft.get('d'));
		assertTrue(5 == ft.get('e'));
		HuffmanTree ht = new HuffmanTree(ft);
		assertTrue(15 == ht.root.priority);
	}
	...
	public void decodeHuffman() {
		HuffmanTree ht = new HuffmanTree(new FrequencyTable("cccddddee"));
		assertEquals('c', ht.decodeChar("1"));
		assertEquals('d', ht.decodeChar("01"));
		assertEquals('e', ht.decodeChar("00"));
	}
